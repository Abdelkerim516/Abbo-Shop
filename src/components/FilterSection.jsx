...
const FilterSection = ({search, setSearch, brand, setBrand, priceRange, setPriceRange, category, setCategory, handleBrandChange, handleCategoryChange}) => {
    ...
    return (
        <div className='bg-gray-100 mt-10 p-4 rounded-md h-max hidden md:block'>
            ...
            {/* category only data */}
            <h1 className='mt-5 font-semibold text-xl'>Catégorie</h1>
            ...
            {/* brand only data */}
            <h1 className='mt-5 font-semibold text-xl mb-3'>Marque</h1>
             <select name="" id="" 
             ...
             {/* price range  */}
             <h1 className='mt-5 font-semibold text-xl mb-3'>Gamme de prix</h1>
             <div className='flex flex-col gap-2'>
                <label htmlFor="">Fourchette de prix: ${priceRange[0]} - ${priceRange[1]}</label>
